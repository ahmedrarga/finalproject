...
public class ExoPlayerRecyclerView extends RecyclerView {
    ...
    private void init(Context context) {
        ...
        videoSurfaceView.setResizeMode(AspectRatioFrameLayout.LAYOUT_MODE_CLIP_BOUNDS);
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        final String mediaUrl = mediaObjects.get(targetPosition).getPath();
        if (mediaUrl != null) {
            StorageReference ref = FirebaseStorage.getInstance().getReference(mediaUrl);
